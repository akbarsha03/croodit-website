...
export const pages = [
  ...
  ["/answers", "How to get paid on time as a trainer, coach or tutor in India", "the hub for the answer guides: the three-step order — send a real invoice, chase the invoice not the person, stop treating digital receipts as a tax risk — plus short answers on why a UPI transfer is not a record, why a QR screenshot stops scaling at about five regulars, why WhatsApp Business and the Business API are the wrong tools for one person, and whether you need a GST number to invoice."],
